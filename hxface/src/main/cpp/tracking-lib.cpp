...
Java_com_hxrainbow_hxface_FaceTracking_initTracking(JNIEnv *env, jobject obj, jbyteArray yuv,
...
JNIEXPORT void JNICALL
Java_com_hxrainbow_hxface_FaceTracking_update(JNIEnv *env, jobject obj, jbyteArray yuv,
...
Java_com_hxrainbow_hxface_FaceTracking_getTrackingNum(JNIEnv *env, jobject obj, jlong handle) {
    FaceTracking *trackingSession = (FaceTracking *) handle;
...
Java_com_hxrainbow_hxface_FaceTracking_getTrackingLandmarkByIndex(JNIEnv *env, jobject obj,jint target, jlong handle) {
    FaceTracking *trackingSession = (FaceTracking *) handle;
...
JNIEXPORT jintArray JNICALL
Java_com_hxrainbow_hxface_FaceTracking_getTrackingLocationByIndex(JNIEnv *env, jobject obj,jint target, jlong handle) {
    FaceTracking *trackingSession = (FaceTracking *) handle;
...
JNIEXPORT jintArray JNICALL
Java_com_hxrainbow_hxface_FaceTracking_getAttributeByIndex(JNIEnv *env, jobject obj,jint target, jlong handle) {
...
Java_com_hxrainbow_hxface_FaceTracking_getEulerAngleByIndex(JNIEnv *env, jobject obj,jint target, jlong handle) {
...
JNIEXPORT jint JNICALL
Java_com_hxrainbow_hxface_FaceTracking_getTrackingIDByIndex(JNIEnv *env, jobject obj,jint target, jlong handle) {
    FaceTracking *trackingSession = (FaceTracking *) handle;
    const Face &info= trackingSession->trackingFace[target];
...
Java_com_hxrainbow_hxface_FaceTracking_createSession(JNIEnv *env, jobject obj, jstring folder) {
...
JNIEXPORT void JNICALL
Java_com_hxrainbow_hxface_FaceTracking_releaseSession(JNIEnv *env, jobject obj, jlong handle) {
    FaceTracking *trackingSession = (FaceTracking *) handle;
